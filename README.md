...
<table>
  <tr>
    <td align="center">
      ...
      <br><em>Estimated gaze  when the subject does not wear the physical trigger.</em>
    </td>
    <td align="center">
      <img src="https://github.com/SecureGaze/SecureGaze/blob/main/figures/mitigated_poisoned.gif" alt="Poisoned Image" width="300"/>
      <br><em>Estimated gaze when the subject wears the physical trigger. </em>
    </td>
    <td align="center">
